...
def find_path(src_point, dst_point, mesh):
    ...
    if curr_box == dst_box:
        ...
        while curr_box and prev_dist[curr_box]:
            x, y = detail_points[curr_box]
            adj_dist, final_dist, detail_points[prev_dist[curr_box]] = calculate_box_points(x, y, dst_point, prev_dist[curr_box])
            if prev_dist[curr_box] == src_box:
                detail_points[prev_dist[curr_box]] = src_point
...
def find_path(src_point, dst_point, mesh):
    ...
    if path_found:
        ...
        while curr_foward_box and prev_dist_foward[curr_foward_box]:
            x, y = detail_points[curr_foward_box]
            adj_dist, final_dist, detail_points[prev_dist_foward[curr_foward_box]] = calculate_box_points(x, y, dst_point, prev_dist_foward[curr_foward_box])
            if prev_dist_foward[curr_foward_box] == src_box:
                detail_points[prev_dist_foward[curr_foward_box]] = src_point
        ...
        while curr_backward_box and prev_dist_backward[curr_backward_box]:
            x, y = detail_points[curr_backward_box]
            adj_dist, final_dist, detail_points[prev_dist_backward[curr_backward_box]] = calculate_box_points(x, y, src_point, prev_dist_backward[curr_backward_box])
            if prev_dist_backward[curr_backward_box] == dst_box:
                detail_points[prev_dist_backward[curr_backward_box]] = dst_point
